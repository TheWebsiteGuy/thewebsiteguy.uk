const basePath = '/var/www/projects/thewebsiteguy.uk';
...
module.exports = async () => {
    ...
    mix.listen('init', function (mix) {
        ...
        mix._api.alias({
            '$': '/var/www/projects/thewebsiteguy.uk/plugins',
            '~': '/var/www/projects/thewebsiteguy.uk',
        });
    ...
    require('/var/www/projects/thewebsiteguy.uk/themes/websiteguy/winter.mix.js');
